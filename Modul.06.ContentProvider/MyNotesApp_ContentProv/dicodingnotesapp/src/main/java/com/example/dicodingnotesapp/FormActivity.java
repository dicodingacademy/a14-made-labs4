...
public class FormActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        noteItem = getIntent().getParcelableExtra(EXTRA_NOTE_ITEM);
        ...
        if (view.getId() == R.id.btn_submit){
            ...
            if (!isEmptyField){
                ...
                if (isUpdate){
                    ...
                    getContentResolver().update(MainActivity.CONTENT_URI, mContentValues, selectionClause, selectionArgs);


                    Toast.makeText(this, "Satu catatan berhasil diupdate", Toast.LENGTH_SHORT).show();
                }else{
                    getContentResolver().insert(MainActivity.CONTENT_URI, mContentValues);
